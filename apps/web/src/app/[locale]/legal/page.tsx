...
const legalPages = [
  ...
  { 
    key: "neutrality", 
    title: { ar: "الحياد", en: "Neutrality", fr: "Neutralité" },
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  { 
    key: "methodology", 
    title: { ar: "المنهجية", en: "Methodology", fr: "Méthodologie" },
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  { 
    key: "archiving", 
    title: { ar: "الأرشفة", en: "Archiving", fr: "Archivage" },
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  { 
    key: "corrections", 
    title: { ar: "التصحيحات", en: "Corrections", fr: "Corrections" },
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  { 
    ...
    title: { ar: "محتوى المرشح", en: "Candidate Content", fr: "Contenu du candidat" },
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  { 
    key: "ai-usage", 
    title: { ar: "استخدام الذكاء الاصطناعي", en: "AI Usage", fr: "Utilisation de l'IA" },
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  { 
    key: "liability", 
    title: { ar: "المسؤولية", en: "Liability", fr: "Responsabilité" },
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  { 
    key: "data-use", 
    title: { ar: "استخدام البيانات", en: "Data Use", fr: "Utilisation des données" },
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export default async function LegalPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <PageLayout
      title={getContent("Legal & Disclaimers", "قانوني وإخلاء المسؤولية", "Légal et avertissements")}
