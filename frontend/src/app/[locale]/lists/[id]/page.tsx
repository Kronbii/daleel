    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        <div className="bg-white/70 backdrop-blur-sm rounded-xl border border-gray-100 p-4 text-center">
          <div className="text-2xl font-semibold text-emerald-600">{list.candidates.length}</div>
          <div className="text-sm text-gray-500">{getContent("Candidates", "مرشحون", "Candidats")}</div>
        </div>
        <div className="bg-white/70 backdrop-blur-sm rounded-xl border border-gray-100 p-4 text-center">
          <div className="text-2xl font-semibold text-emerald-600">{list.district.seatCount}</div>
      ...
      {(list.announcedAt || list.notes) && (
        <div className="bg-white/70 backdrop-blur-sm rounded-xl border border-gray-100 p-5 mb-8">
