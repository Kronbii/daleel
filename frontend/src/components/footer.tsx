      ...
      <div className="container mx-auto px-4 py-8 sm:py-10 md:py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col gap-8 sm:gap-10">
            ...
            {/* Links - Centered grid on mobile */}
            <div className="grid grid-cols-2 gap-8 sm:flex sm:justify-center sm:gap-16 md:gap-20">
              <div className="text-center sm:text-left">
          ...
          {/* Bottom bar */}
          <div className="mt-8 sm:mt-10 pt-6 border-t border-gray-200 flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
