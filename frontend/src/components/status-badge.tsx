...
// Type definitions for candidate and list status
type CandidateStatus = "POTENTIAL" | "OFFICIAL" | "WITHDRAWN" | "DISQUALIFIED";
type ListStatus = "DRAFT" | "ANNOUNCED" | "OFFICIAL" | "WITHDRAWN";

interface StatusBadgeProps {
  status: CandidateStatus | ListStatus | string;
  className?: string;
}
